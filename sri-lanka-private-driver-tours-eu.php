...
<body>
    ...
    <section class="hero">
        ...
        <div class="container">
            <h1>Explore Sri Lanka Your Way <br/> Private Driver & Tailor-Made Tours</h1>
            <p>Travel July to October or anytime. Your own English-speaking driver, flexible itinerary, boutique stays and local insight — built around you, not a group schedule.</p>
           <div class="hero-ctas">
                ...
                WhatsApp a Local Planner
                </a>
            </div>
    </section>

    <section class="container">
        <h2> Designed for Long-Haul Travellers, Run by Locals</h2>
        <p class="intro-text">Long-haul flights deserve more than a bus tour. We bridge Western expectations with real local access — one car, one driver-guide, zero stress.</p>
        
        <div class="grid">
            <div class="card">
                <i>🗺️</i>
                <h3>Tailored, Not Packaged</h3>
                <p>Tell us your dates and interests. We create a private route — culture, wildlife, beaches, hill country — with the freedom to change it on the road.</p>
            </div>
            <div class="card">
                <i>🤝</i>
                <h3>Your Driver Is Your Guide</h3>
                <p>Skip the tourist traps. Our drivers are licensed guides who know the best times, hidden stops and family-run places you won’t find in guidebooks.</p>
            </div>
            <div class="card">
                <i>🛡️</i>
                <h3>Clear & Personal</h3>
                <p>You get one clear quote after you approve the plan. Licensed cars, full insurance, 24/7 local support on WhatsApp. No surprises.</p>
            </div>
        </div>
    </section>
    ...
    <section class="video-section">
        <div class="container">
            <h2 class="video-section-title">See Sri Lanka Through Our Guests</h2>
    ...
    <section class="bg-light">
        <div class="container">
            ...
            <p class="intro-text">Ceylon Travel Lanka is the go-to for private driver tours for guests flying 10+ hours from Europe. We’re known for punctual airport pickups, clean late-model cars, and drivers who understand Western travel standards — from child seats to dietary needs.</p>
    ...
    <section class="container ta-container">
        ...
        <div class="ta-content">
            ...
            <h2 class="ta-title">Rated 5/5 by Our Travellers</h2>
            <p class="ta-text">We are incredibly proud to maintain a flawless <strong>5.0-star rating</strong> backed by independent reviews from international travelers. From punctual airport pickups to breathtaking coastal routes, our commitment to safety, transparency, and hospitality is fully verified by the world’s largest travel platform.</p>
    ...
    <section id="booking-form" class="bg-light">
        <div class="container">
            <h2>Get Your Custom Sri Lanka Plan Started in Minutes</h2>
            <div class="form-box">
                ...
                <form id="tour-inquiry-form" class="contact-form">
                    <div class="input-group">
                        ...
                        <input type="hidden" name="campaign" id="campaign" value="EUOne">
                    </div>
                    <div class="input-group">
    ...
    <section class="contact-section">
        <div class="container">
            <h2 class="section-title">Talk to a Sri Lanka Specialist</h2>
            <p class="intro-text">Available daily on WhatsApp, phone and email for route advice and custom planning.</p>
