...
$preloadBanner = BASE_URL . "images/images/banner.webp";
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="slider-button d-flex justify-content-center">
                <a href="#price" class="nir-btn me-4" tabindex="0">View Rates</a>
    ...
    <section class="bg-light">
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item"><img src="images/campaign/1.jpeg" alt="International travelers enjoying Sri Lanka tour" loading="lazy"></div>
                <div class="gallery-item"><img src="images/campaign/2.jpg" alt="Modern private vehicle in Sri Lanka" loading="lazy"></div>
                <div class="gallery-item"><img src="images/campaign/3.jpeg" alt="Happy couple with private chauffeur" loading="lazy"></div>
                <div class="gallery-item"><img src="images/campaign/4.jpg" alt="Clean and comfortable car interior" loading="lazy"></div>
                <div class="gallery-item"><img src="images/campaign/5.jpg" alt="Clean and comfortable car interior" loading="lazy"></div>
                <div class="gallery-item"><img src="images/campaign/6.jpg" alt="Clean and comfortable car interior" loading="lazy"></div>
            </div>
        </div>
    </section>
