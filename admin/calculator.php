...
<head>
    ...
    <title>Tour Cost Calculator</title>
...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col">
    ...
    <header class="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
        ...
        <div class="flex justify-between h-16 items-center gap-2">
            ...
            <!-- Reports Link -->
            <a href="<?= BASE_URL ?>admin/calculator" class="px-3.5 py-2 text-sm font-semibold rounded-lg bg-indigo-50 text-indigo-600 transition">
                Quotation
            </a>
            </nav>
        ...
        <div id="mobileMenu" class="hidden md:hidden border-t border-slate-100 py-3 space-y-1">
            ...
            <a href="<?= BASE_URL ?>admin/calculator" class="block px-3 py-2 text-sm font-semibold rounded-lg bg-indigo-50 text-indigo-600">
            Quotation
            </a>
        </div>
