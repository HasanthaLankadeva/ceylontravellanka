    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 step-card mb-6">
                ...
                <h3><a href="<?= BASE_URL ?>services/airport-transfer">Airport Transfer</a></h3>
                <p class="mb-2">Safe and reliable airport pickup and drop-off services across Sri Lanka with professional drivers.</p>
                <p class="mb-0"><a class="theme" href="<?= BASE_URL ?>services/airport-transfer">Read More →</a></p>
            </div>
            <div class="col-md-4 step-card mb-6">
                <img src="<?= BASE_URL ?>images/s_2.webp" alt="Search Destination" class="step-icon mb-3">
                <h3><a href="<?= BASE_URL ?>services/private-driver-sri-lanka">Private Driver in Sri Lanka</a></h3>
                <p class="mb-2">Hire a private driver for flexible and comfortable travel around the island at your own pace.</p>
                <p class="mb-0"><a class="theme" href="<?= BASE_URL ?>services/private-driver-in-sri-lanka">Read More →</a></p>
            </div>
            <div class="col-md-4 step-card mb-6">
                <img src="<?= BASE_URL ?>images/s_3.webp" alt="Search Destination" class="step-icon mb-3">
                <h3><a href="<?= BASE_URL ?>services/car-rental-with-driver">Car Rental with Driver</a></h3>
                <p class="mb-2">Choose from a range of vehicles with experienced drivers for a smooth travel experience.</p>
                <p class="mb-0"><a class="theme" href="<?= BASE_URL ?>services/car-rental-with-driver">Read More →</a></p>
            </div>
        </div>
    </div>
</section>
